  ...
  return (
    <nav className="bg-gray-200 border-gray-200 dark:bg-gray-900 w-full">
      <div className="w-full flex flex-wrap items-center justify-between mx-auto p-4 dark:bg-gray-900">
        ...
        >
          {/* <img src="/public/Ahadizpng.png" className="h-8" alt="Ahadiz Logo" /> */}
          <Image
            src="/Ahadizpng.png"
            alt="Flowbite Logo"
            width={40} // The width in pixels
            height={40} // The height in pixels
            className="h-10 rounded-full"
          />
          <span className="self-center text-2xl font-semibold whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-r  from-black via-blue-500 to-orange-500 dark:from-white dark:via-blue-500 dark:to-orange-600">
            Ahadiz
          </span>
        </a>
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          {isProfileOpen && (
            <div
              className="z-50 absolute  top-11 right-10 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
              id="user-dropdown"
            >
